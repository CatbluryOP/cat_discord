...
Config.DiscordWhitelist = { -- Restrict if someone can fly in if they lack specific Discord role(s)
    ...
    deniedMessage = 'https://discord.gg/Catblury : Join our Discord server and verify to play!', -- Message for those who lack whitelisted role(s)
    whitelistedRoles = {
      --'ROLE_ID_HERE',  
...
Config.DiscordQueue = {
    ...
    title = 'Catblury Scripts', -- Maybe server name here?
...
strings = {
    verifyConnection = '[cat_discord] Verifying connection...',
    verifyLauncher = '[cat_discord] Verifying Launcher...',
    verifyDiscord = '[cat_discord] Verifying Discord...',
    verifyQueue = '[cat_discord] Adding to queue...',
    notInDiscord = '[cat_discord] You must join the discord: https://discord.gg/wasabiscripts to fly in!',
    noDiscord = '[cat_discord] You must have Discord downloaded, installed, and running to connect!',
    error = '[cat_discord] An error has occured, please try again!'
}
